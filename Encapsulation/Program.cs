...
namespace Encapsulation
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //По принцип в приложение се хвърлят Exception - и и който ни трябват се хващат. Така е прието в правилото за валидации, да се хвърлят Exception - и, а после се прихващат от който трябва
